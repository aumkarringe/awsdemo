 ...
 */
metabase.shared.formatting.constants.abbreviated_QMARK_ = (function metabase$shared$formatting$constants$abbreviated_QMARK_(p__79527){
var map__79528 = p__79527;
var map__79528__$1 = cljs.core.__destructure_map(map__79528);
var output_density = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79528__$1,new cljs.core.Keyword(null,"output-density","output-density",105174015));
 ...
 */
metabase.shared.formatting.constants.condense_ranges_QMARK_ = (function metabase$shared$formatting$constants$condense_ranges_QMARK_(p__79529){
var map__79531 = p__79529;
var map__79531__$1 = cljs.core.__destructure_map(map__79531);
var output_density = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79531__$1,new cljs.core.Keyword(null,"output-density","output-density",105174015));
var fexpr__79532 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["compact",null,"condensed",null], null), null);
return (fexpr__79532.cljs$core$IFn$_invoke$arity$1 ? fexpr__79532.cljs$core$IFn$_invoke$arity$1(output_density) : fexpr__79532.call(null,output_density));
});
/**
