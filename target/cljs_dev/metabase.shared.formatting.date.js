...
var temp__5802__auto__ = (function (){var G__79597 = new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(options__$1);
return (metabase.shared.formatting.date.parameter_formatters.cljs$core$IFn$_invoke$arity$1 ? metabase.shared.formatting.date.parameter_formatters.cljs$core$IFn$_invoke$arity$1(G__79597) : metabase.shared.formatting.date.parameter_formatters.call(null,G__79597));
})();
...
var vec__79598 = metabase.shared.util.time.to_range.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([t,options__$1], 0));
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79598,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79598,(1),null);
...
metabase.shared.formatting.date.format_range_with_unit_inner = (function metabase$shared$formatting$date$format_range_with_unit_inner(p__79601,options){
var vec__79602 = p__79601;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79602,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79602,(1),null);
...
var map__79605 = metabase.shared.formatting.internal.date_options.prepare_options(options);
var map__79605__$1 = cljs.core.__destructure_map(map__79605);
var options__$1 = map__79605__$1;
var is_exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79605__$1,new cljs.core.Keyword(null,"is-exclude","is-exclude",1738462979));
var no_range = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79605__$1,new cljs.core.Keyword(null,"no-range","no-range",-1511420040));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79605__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79605__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
var t = metabase.shared.util.time.coerce_to_timestamp.cljs$core$IFn$_invoke$arity$2(value,options__$1);
if(cljs.core.truth_(is_exclude)){
var G__79606 = unit;
var G__79606__$1 = (((G__79606 instanceof cljs.core.Keyword))?G__79606.fqn:null);
switch (G__79606__$1) {
case "hour-of-day":
...
if(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(unit,new cljs.core.Keyword(null,"week","week",-1326473278));
if(and__5000__auto__){
var and__5000__auto____$1 = (function (){var fexpr__79607 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["tooltip",null,"cell",null], null), null);
return (fexpr__79607.cljs$core$IFn$_invoke$arity$1 ? fexpr__79607.cljs$core$IFn$_invoke$arity$1(type) : fexpr__79607.call(null,type));
})();
...
var fexpr__79608 = metabase.shared.formatting.internal.date_formatters.options__GT_formatter(options__$1);
return (fexpr__79608.cljs$core$IFn$_invoke$arity$1 ? fexpr__79608.cljs$core$IFn$_invoke$arity$1(t) : fexpr__79608.call(null,t));
 ...
 */
metabase.shared.formatting.date.date__GT_iso_string = (function metabase$shared$formatting$date$date__GT_iso_string(d){
return metabase.shared.formatting.internal.date_formatters.big_endian_day(metabase.shared.util.time.coerce_to_timestamp.cljs$core$IFn$_invoke$arity$1(d));
});
/**
 * Coerce datetime and format as iso string.
 */
metabase.shared.formatting.date.datetime__GT_iso_string = (function metabase$shared$formatting$date$datetime__GT_iso_string(dt){
return metabase.shared.formatting.internal.date_formatters.__GT_iso(metabase.shared.util.time.coerce_to_timestamp.cljs$core$IFn$_invoke$arity$1(dt));
});
...
Object.defineProperty(module.exports, "date__GT_iso_string", { enumerable: true, get: function() { return metabase.shared.formatting.date.date__GT_iso_string; } });
Object.defineProperty(module.exports, "datetime__GT_iso_string", { enumerable: true, get: function() { return metabase.shared.formatting.date.datetime__GT_iso_string; } });
