...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_54121 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_54121(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_54123 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_54123(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_54124 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_54124(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_54125 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_54125(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_54126 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_54126(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_54127 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_54127(reader);
}
});
...
var G__54133 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__54134 = s.append(c);
c = G__54133;
s = G__54134;
continue;
}
