...
$CLJS.SHADOW_ENV.setLoaded("devtools.formatters.printing.js");
...
var len__5726__auto___34220 = arguments.length;
var i__5727__auto___34221 = (0);
while(true){
if((i__5727__auto___34221 < len__5726__auto___34220)){
args__5732__auto__.push((arguments[i__5727__auto___34221]));

var G__34222 = (i__5727__auto___34221 + (1));
i__5727__auto___34221 = G__34222;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq34185){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34186,G__34187,seq34185__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__34188_SHARP_){
return (!((cljs.core.meta(p1__34188_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34199__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e34200){var _e__33440__auto__ = e34200;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e34202){var _e__33440__auto__ = e34202;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__34207 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__34208 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__34208);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34211__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__34207);
}});
...
var temp__5802__auto___34238 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___34238)){
var managed_print_level_34239 = temp__5802__auto___34238;
var _STAR_print_level_STAR__orig_val__34214_34240 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__34215_34241 = managed_print_level_34239;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__34215_34241);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__34213_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__34213_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__34214_34240);
}} else {
job_fn();
}
