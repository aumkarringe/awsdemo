...
function createPropDefinition(propName, prop, options) {
    const createNumericDefaultValue = (value) => {
        if (value < 0) {
            return typescript_1.default.factory.createPrefixUnaryExpression(typescript_1.default.SyntaxKind.MinusToken, typescript_1.default.factory.createNumericLiteral(-value));
        }
