...
var p3Linear2p3 = function (p3l) {
    return srgb_1.srgbLinear2rgb(p3l);
};
...
var p3ToXYZ = function (args) {
    var p3_linear = exports.p32p3Linear([args[0], args[1], args[2]]);
    return exports.p3LinearToXyz([p3_linear[0], p3_linear[1], p3_linear[2]]);
};
...
var p3FromXYZ = function (args) {
    var _a = exports.p3Linear2p3(exports.xyzToP3Linear([args[0], args[1], args[2]])), r = _a[0], g = _a[1], b = _a[2];
    return [r, g, b, args[3]];
};
...
var convertP3 = function (args) {
    var xyz = exports.p3ToXYZ([args[0], args[1], args[2]]);
