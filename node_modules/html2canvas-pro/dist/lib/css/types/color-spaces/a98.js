...
var a98FromXYZ = function (args) {
    var _a = exports.a98Linear2a98(exports.xyz2a98Linear([args[0], args[1], args[2]])), r = _a[0], g = _a[1], b = _a[2];
    return [r, g, b, args[3]];
};
...
var convertA98rgb = function (args) {
    var srgb_linear = srgb_1.xyz2rgbLinear(exports.a98Linear2xyz(exports.a982a98Linear([args[0], args[1], args[2]])));
    return color_utilities_1.packSrgbLinear([srgb_linear[0], srgb_linear[1], srgb_linear[2], args[3]]);
};
