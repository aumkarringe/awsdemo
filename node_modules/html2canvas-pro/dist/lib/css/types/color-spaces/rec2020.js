...
var rec2020LinearToXyz = function (rec) {
    return color_utilities_1.multiplyMatrices(
...
var rec2020ToXYZ = function (args) {
    var rec2020_linear = exports.rec20202rec2020Linear([args[0], args[1], args[2]]);
    return exports.rec2020LinearToXyz([rec2020_linear[0], rec2020_linear[1], rec2020_linear[2]]);
};
...
var rec2020FromXYZ = function (args) {
    var _c = exports.rec2020Linear2rec2020(exports.xyzToRec2020Linear([args[0], args[1], args[2]])), r = _c[0], g = _c[1], b = _c[2];
    return [r, g, b, args[3]];
};
...
var convertRec2020 = function (args) {
    var xyz = exports.rec2020ToXYZ([args[0], args[1], args[2]]);
    return color_utilities_1.packXYZ([xyz[0], xyz[1], xyz[2], args[3]]);
};
