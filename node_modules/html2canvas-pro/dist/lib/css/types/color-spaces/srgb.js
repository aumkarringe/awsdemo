...
var srgbFromXYZ = function (args) {
    var _a = exports.srgbLinear2rgb(exports.xyz2rgbLinear([args[0], args[1], args[2]])), r = _a[0], g = _a[1], b = _a[2];
    return [r, g, b, args[3]];
};
...
var srgbLinearFromXYZ = function (args) {
    var _a = exports.xyz2rgbLinear([args[0], args[1], args[2]]), r = _a[0], g = _a[1], b = _a[2];
    return [
        color_utilities_1.clamp(Math.round(r * 255), 0, 255),
        color_utilities_1.clamp(Math.round(g * 255), 0, 255),
        color_utilities_1.clamp(Math.round(b * 255), 0, 255),
        args[3]
    ];
};
