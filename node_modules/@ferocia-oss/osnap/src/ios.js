    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, which_1.default)('xcrun')];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    execa = (_a.sent()).execa;
                    return [4 /*yield*/, execa(xcrunPath, ['simctl', 'list', 'devices'])];
                case 2:
                    response = _a.sent();
                    stdout = response.stdout;
                    devices = stdout
                        .split('\n')
                        .filter(function (line) { return line.includes('(Booted)'); })
                        .map(function (line) { return line.replace(/.+\(([A-F0-9\-]+)\).+/, '$1'); });
                    // not enough devices?
                    if (devices.length === 0) {
