...
exports.updateBrowsers = exports.getPuppeteerBrowserPath = exports.getPlaywrightBrowserPath = exports.ensurePuppeteerBrowsersInstalled = exports.ensurePlaywrightBrowsersInstalled = exports.ensureBrowsersInstalled = exports.getExecutablePath = void 0;
...
function ensureBrowsersInstalled(kind_1, force_1) {
    return __awaiter(this, arguments, void 0, function* (kind, force, opts = {}) {
        ...
        switch (process.platform) {
            ...
            case "win32":
                if (["all", "chromium"].includes(kind)) {
                    yield installReplayBrowser(getBrowserDownloadFileName("win32:chromium"), "replay-chromium", "replay-chromium", force, opts);
                }
                break;
        }
    });
}
exports.ensureBrowsersInstalled = ensureBrowsersInstalled;
/**
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (opts.browsers) {
            for (const browserName of opts.browsers) {
                yield ensureBrowsersInstalled(browserName, true, opts);
            }
        }
        else {
...
function getExecutablePath(browserName, opts) {
    ...
    return executablePathParts ? path_1.default.join(getRuntimesDirectory(opts), ...executablePathParts) : null;
}
...
function installReplayBrowser(name_1, srcName_1, dstName_1) {
    return __awaiter(this, arguments, void 0, function* (name, srcName, dstName, force = false, opts = {}) {
        const replayDir = (0, utils_1.getDirectory)(opts);
