...
const test_v2_2_0 = (0, superstruct_1.assign)(test_v2_1_0, (0, superstruct_1.object)({
    executionId: (0, superstruct_1.string)(),
    executionGroupId: (0, superstruct_1.string)(),
    maxAttempts: (0, superstruct_1.number)(),
}));
const v2_1_0 = (0, superstruct_1.assign)(v2_0_0, (0, superstruct_1.object)({
    tests: (0, superstruct_1.array)(test_v2_1_0),
}));
const v2_2_0 = (0, superstruct_1.assign)(v2_1_0, (0, superstruct_1.object)({
    tests: (0, superstruct_1.array)(test_v2_2_0),
}));
exports.default = {
    "2.2.0": v2_2_0,
    "2.1.0": v2_1_0,
