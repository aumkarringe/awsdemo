...
/* harmony import */ var metabase_redux_ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! metabase/redux/ui */ "./redux/ui.ts");
...
const NewItemMenu = _ref => {
  ...
  const lastUsedDatabaseId = useSelector(state => (0,metabase_selectors_settings__WEBPACK_IMPORTED_MODULE_5__.getSetting)(state, "last-used-native-database-id"));
  const menuItems = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    ...
    items.push({
      ...
      icon: "dashboard",
      action: () => dispatch((0,metabase_redux_ui__WEBPACK_IMPORTED_MODULE_1__.setOpenModal)("dashboard"))
    }, {
      title: ttag__WEBPACK_IMPORTED_MODULE_3__.t`Collection`,
      icon: "folder",
      action: () => dispatch((0,metabase_redux_ui__WEBPACK_IMPORTED_MODULE_1__.setOpenModal)("collection"))
    });
    if (hasNativeWrite) {
    ...
    if (hasModels && hasDatabaseWithActionsEnabled && hasNativeWrite) {
      items.push({
        ...
        icon: "bolt",
        action: () => dispatch((0,metabase_redux_ui__WEBPACK_IMPORTED_MODULE_1__.setOpenModal)("action"))
      });
    }
    if (hasDataAccess) {
      items.push({
    ...
    items.push({
      ...
      icon: "chat",
      action: () => dispatch((0,metabase_redux_ui__WEBPACK_IMPORTED_MODULE_1__.setOpenModal)("chatWithAI")) // Dispatch action to open chat modal
    });
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(metabase_components_EntityMenu__WEBPACK_IMPORTED_MODULE_2__["default"], {
    className: className,
    items: menuItems,
    trigger: trigger,
...
_s(NewItemMenu, "E4jqDED9YsQNrh42RsCnlWWSjrw=", false, function () {
  return [react_redux__WEBPACK_IMPORTED_MODULE_7__.useDispatch, useSelector];
});
_c = NewItemMenu;
...
//# sourceMappingURL=app-main.cfda6b1eb8a84d92507c.hot-update.js.map