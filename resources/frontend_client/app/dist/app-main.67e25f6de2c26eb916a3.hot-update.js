...
const NewItemMenu = _ref => {
  ...
  const menuItems = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    ...
    items.push({
      ...
      icon: "chat",
      action: () => dispatch((0,metabase_redux_ui__WEBPACK_IMPORTED_MODULE_5__.setOpenModal)("chatWithAI"))
    });
    return items;
...
//# sourceMappingURL=app-main.67e25f6de2c26eb916a3.hot-update.js.map