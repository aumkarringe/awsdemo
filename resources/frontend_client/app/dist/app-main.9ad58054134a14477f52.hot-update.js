...
/* harmony export */ });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! @reduxjs/toolkit */ "../../../node_modules/reselect/dist/reselect.mjs");
...
const ADMIN_SETTINGS_SECTIONS = {
  ...
  email: {
    name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`Email`,
    order: 40,
    component: _components_Email_SettingsEmailForm__WEBPACK_IMPORTED_MODULE_12__.SettingsEmailForm,
    settings: [{
      key: "email-from-name",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`From Name`,
      placeholder: "Metabase",
      type: "string",
      required: false
    }, {
      key: "email-from-address",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`From Address`,
      placeholder: "metabase@yourcompany.com",
      type: "string",
      required: true,
      validations: [["email", ttag__WEBPACK_IMPORTED_MODULE_0__.t`That's not a valid email address`]]
    }, {
      key: "email-reply-to",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`Reply-To Address`,
      placeholder: "metabase-replies@yourcompany.com",
      type: "string",
      required: false,
      widget: _components_widgets_SettingCommaDelimitedInput__WEBPACK_IMPORTED_MODULE_24__["default"],
      validations: [["email_list", ttag__WEBPACK_IMPORTED_MODULE_0__.t`That's not a valid email address`]]
    }, {
      key: "bcc-enabled?",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`Add Recipients as CC or BCC`,
      description: ttag__WEBPACK_IMPORTED_MODULE_0__.t`Control the visibility of recipients.`,
      options: [{
        value: true,
        name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`BCC - Hide recipients`
      }, {
        value: false,
        name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`CC - Disclose recipients`
      }],
      defaultValue: true,
      widget: _components_Email_BccToggleWidget__WEBPACK_IMPORTED_MODULE_11__.BccToggleWidget
    }]
  },
  "email/smtp": {
    component: metabase_admin_settings_components_Email_SMTPConnectionForm__WEBPACK_IMPORTED_MODULE_2__.SMTPConnectionForm,
    settings: [{
      key: "email-smtp-host",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`SMTP Host`,
      ...
      key: "email-smtp-port",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`SMTP Port`,
      placeholder: "587",
      type: "number",
      required: true,
      validations: [["integer", ttag__WEBPACK_IMPORTED_MODULE_0__.t`That's not a valid port number`]]
    }, {
      key: "email-smtp-security",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`SMTP Security`,
      description: null,
      type: "radio",
      options: {
        none: "None",
      ...
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`SMTP Username`,
      description: null,
      placeholder: "nicetoseeyou",
      type: "string"
    }, {
      key: "email-smtp-password",
      display_name: ttag__WEBPACK_IMPORTED_MODULE_0__.t`SMTP Password`,
      description: null,
      placeholder: "Shhh...",
      type: "password",
      getHidden: () => metabase_lib_settings__WEBPACK_IMPORTED_MODULE_5__["default"].isHosted()
    }]
  },
  // slack: {
  //   name: "Slack",
...
const getSettings = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_29__.createSelector)(state => state.admin.settings.settings, state => state.admin.settings.warnings, (settings, warnings) => settings.map(setting => warnings[setting.key] ? {
  ...setting,
...
const getSettingValues = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_29__.createSelector)(getSettings, settings => {
  const settingValues = {};
...
const getNewVersionAvailable = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_29__.createSelector)(getSettings, settings => {
  return metabase_lib_settings__WEBPACK_IMPORTED_MODULE_5__["default"].newVersionAvailable(settings);
});
const getSections = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_29__.createSelector)(getSettings, getDerivedSettingValues, metabase_selectors_user__WEBPACK_IMPORTED_MODULE_8__.getUserIsAdmin, (settings, derivedSettingValues, isAdmin) => {
...
const getActiveSection = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_29__.createSelector)(getActiveSectionName, getSections, function () {
...
//# sourceMappingURL=app-main.9ad58054134a14477f52.hot-update.js.map